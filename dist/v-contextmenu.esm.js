function handleContext(e) {
  ...
  const menuWidth = +window.getComputedStyle(contextMenu)['width'].replace(/px/, ''); // horizontal
...
var contextmenu = {
  inserted(el, binding, vm) {
    const contextMenu = document.createElement('div'); // document.body.appendChild(contextMenu)
